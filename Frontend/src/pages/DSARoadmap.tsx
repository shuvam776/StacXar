...
import { dsaTopics, type SubTopic } from '../data/dsaData';
            ...
            >
                ...
                >
                    ...
                    <div className="relative z-10 w-full px-2">
                        <h1 className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter mb-4 uppercase italic break-words">
                            DSA <span className="text-primary italic uppercase">Journey</span>
                        </h1>
                        <p className="text-gray-400 text-xs sm:text-sm md:text-lg max-w-xl mx-auto">Master Algorithms Step by Step.</p>
                    </div>
                </motion.header>
                ...
                <div className="relative z-10 flex flex-col gap-10 md:gap-24">
                    ...
                    <div className="absolute inset-0 pointer-events-none z-0">
                        {dsaTopics.flatMap(topic => topic.subtopics).map((sub, index, allSubtopics) => {
                    ...
                    {allSubtopics.map((sub, index) => {
                        ...
                        const topics = dsaTopics; // Closure reference
...
export default React.memo(DSARoadmap);
